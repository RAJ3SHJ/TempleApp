...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void _onServiceTap(String title) {
    switch (title) {
      ...
      case 'Live Telecast':
        Navigator.push(context,
            MaterialPageRoute(builder: (_) => const LiveTelecastScreen()));
        break;
      case 'Video Library':
        Navigator.push(context,
        ...
        children: [
          Row(
            children: [
              Container(
                ...
                child: const Icon(Icons.church_rounded, size: 18, color: AppTheme.navy),
              ),
          ...
          Align(
            ...
            child: Column(
              ...
              children: [
                Text('$_greeting, John',
                    style: const TextStyle(fontSize: 20, fontWeight: FontWeight.w600, color: AppTheme.white)),
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            ...
            style: TextStyle(fontSize: 14, fontStyle: FontStyle.italic, color: AppTheme.textPrimary, height: 1.7),
          ),
          const SizedBox(height: 8),
          const Text('John 3:16',
              style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: AppTheme.gold)),
        ],
      ),
    );
  }
    ...
    return Padding(
      ...
      child: Text(label.toUpperCase(),
          style: const TextStyle(
              fontSize: 11, fontWeight: FontWeight.w600, color: AppTheme.textSecondary, letterSpacing: 0.8)),
    );
  }
  ...
  Widget _buildDonationSummary() {
    return Row(
      children: [
        Expanded(child: _statCard(label: 'All Time Total', value: '₹1,24,500', sub: 'Since 2019')),
        const SizedBox(width: 10),
        Expanded(child: _statCard(label: 'This Year', value: '₹18,200', sub: 'Jan – May 2026')),
      ],
    );
  }
  ...
  Widget _statCard({required String label, required String value, required String sub}) {
    return Container(
      ...
      decoration: BoxDecoration(
          color: AppTheme.white, borderRadius: BorderRadius.circular(12), border: Border.all(color: AppTheme.border)),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(label, style: const TextStyle(fontSize: 12, color: AppTheme.textSecondary)),
          const SizedBox(height: 6),
          Text(value, style: const TextStyle(fontSize: 21, fontWeight: FontWeight.w700, color: AppTheme.navy)),
  ...
  Widget _buildServicesGrid() {
    final services = [
      {'icon': Icons.receipt_long_outlined, 'title': 'Donation History', 'desc': 'View all payments'},
      {'icon': Icons.play_circle_outline_rounded, 'title': 'Video Library', 'desc': 'Sermons & teachings'},
      {'icon': Icons.live_tv_outlined, 'title': 'Live Telecast', 'desc': 'Watch live service'},
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Icon(service['icon'] as IconData, size: 18, color: AppTheme.navy),
                ),
                const SizedBox(height: 8),
  ...
  Widget _buildBottomNav() {
    ...
    return Container(
      decoration: const BoxDecoration(
          color: AppTheme.white, border: Border(top: BorderSide(color: AppTheme.border))),
